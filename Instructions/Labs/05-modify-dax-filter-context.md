...
1. Na caixa**Pesquisar**, digite_Layout_.

1. Defina a propriedade**Layout** como_Tabular_.
...
1. No**modo de exibição Modelo**, coloque as três novas medidas em uma pasta de exibição nomeada_Proporções_.
