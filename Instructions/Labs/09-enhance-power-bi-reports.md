...
1. Defina a seção **Ação** como **Ativado**, expanda a guia e defina a propriedade de **Tipo** como **Marcar**.
...
1. Na janela **Publicar no Power BI**, verifique se _Meu workspace_ está selecionado.
