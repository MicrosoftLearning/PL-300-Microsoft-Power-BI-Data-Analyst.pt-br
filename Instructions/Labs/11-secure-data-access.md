...
Neste laboratório, você vai impor a segurança em nível de linha para garantir que cada vendedor só possa analisar dados de vendas para as regiões atribuídas a ele. Você aprenderá como:

- Implemente a RLS (segurança em nível de linha) dinâmica no Power BI.
- Crie e teste uma função usando USERPRINCIPALNAME().
...
1. Para atribuir um filtro, selecione a tabela **Vendedor (Desempenho)** e selecione **Alternar para o editor do DAX** na seção **Regras**.
...
1. Observe a faixa vermelha acima da página do relatório, descrevendo o contexto de segurança do teste.
...
1. Para interromper o teste, no lado direito da faixa vermelha, selecione **Parar de Exibir**.
