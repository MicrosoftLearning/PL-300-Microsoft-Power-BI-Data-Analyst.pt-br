...
1. Selecione **Importar > Relatório, Relatório Paginado ou Pasta de Trabalho > Neste computador**.
...
1. No serviço do Power BI, abra o relatório **12-Starter-Sales Analysis**.
...
1. Quando solicitado, selecione **Monitoramento de Vendas** no menu suspenso, selecione **Fixar**.
...
1. Posicione o cursor sobre o bloco **Vendas acumuladas no ano** e, no canto superior direito do bloco, selecione as reticências e escolha **Editar Detalhes**.
    ...
    ![Figura 50](Linked_image_Files/12-create-power-bi-dashboard_image36.png)
...
1. No arquivo do Power BI Desktop, no painel **Dados**, clique com o botão direito do mouse na tabela **Vendas** e selecione **Atualizar > Dados**.
