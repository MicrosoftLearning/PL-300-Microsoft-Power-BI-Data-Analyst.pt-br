...
## **Introdução – Criar um modelo semântico**
...
*Esse método criará um relatório e um modelo semântico. Usaremos apenas o modelo semântico para criar um novo relatório neste exercício. Este mesmo processo poderia ser feito com um modelo semântico existente de um relatório diferente em vez de carregar um novo. Além disso, se você não estiver usando o relatório, as práticas recomendadas do workspace sugerem que você exclua o arquivo desnecessário.*

## **Criar o relatório**

Nesta tarefa, você criará uma conexão dinâmica real com o modelo semântico do Power BI criado na última tarefa e, em seguida, criará um novo relatório de **Exploração de Vendas**.
