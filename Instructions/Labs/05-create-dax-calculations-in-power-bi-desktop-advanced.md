...
1. Na **Página 3**, adicione um visual de matriz.
    ...
    ![Figura 13](Linked_image_Files/05-create-dax-calculations-in-power-bi-desktop_image23.png)
...
1. Adicione também o campo **Vendas \| Vendas** à caixa Valores.
...
1. Na caixa **Pesquisar**, digite **Layout**.

1. Defina a propriedade **Layout** como **Tabular**.
