...
1. Observe que o valor da medida de`Sales YoY Growth` para_julho de 2018_ é o valor de vendas para_julho de 2017_.
...
1. Verifique que o crescimento YoY para_julho de 2018_ é de 392,83%.
...
1. No**modo de exibição Modelo**, coloque as duas novas medidas em uma pasta de exibição chamada_Inteligência de dados temporais_.
